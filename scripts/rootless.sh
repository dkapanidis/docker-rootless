...
do_install() {
	...
	STATIC_RELEASE_URL="https://download.docker.com/linux/static/stable/x86_64/docker-19.03.1.tgz"
	STATIC_RELEASE_ROOTLESS_URL="https://download.docker.com/linux/static/stable/x86_64/docker-rootless-extras-19.03.1.tgz"
